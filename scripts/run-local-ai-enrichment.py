...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dry-run", action="store_true", help="Analyze and cache results without writing audio tags.")
...
def main() -> int:
    ...
    dry_run = args.dry_run or not args.write_tags
    ...
    if dry_run:
        print("Dry run complete. Re-run with --write-tags to write cleaned tags to audio files.")
